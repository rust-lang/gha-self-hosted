...
source "qemu" "ubuntu-aarch64" {
  ...
  iso_checksum_url       = "https://cloud-images.ubuntu.com/releases/${var.ubuntu_codename}/release/SHA256SUMS"
  iso_url                = "http://cloud-images.ubuntu.com/releases/${var.ubuntu_codename}/release/ubuntu-${var.ubuntu_version}-server-cloudimg-arm64.img"
...
source "qemu" "ubuntu-x86_64" {
  ...
  iso_checksum_type      = "sha256"
  iso_checksum_url       = "https://cloud-images.ubuntu.com/releases/${var.ubuntu_codename}/release/SHA256SUMS"
  iso_url                = "http://cloud-images.ubuntu.com/releases/${var.ubuntu_codename}/release/ubuntu-${var.ubuntu_version}-server-cloudimg-amd64.img"
