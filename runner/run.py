...
class VM:
    def __init__(self, base, env):
        ...
        self._process = None
        self._qmp_port = random.randint(*QMP_PORT_RANGE)
    ...
    def run(self):
        ...
        self._process = subprocess.Popen([
            ...
            # Forward the 22 port on the host, as 2222.
            ...
            # The QMP port is used by the shutdown() method to send the
            # shutdown signal to the QEMU VM instead of killing it.
            "-qmp", "telnet:127.0.0.1:" + str(self._qmp_port) + ",server,nowait",
